...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('frontend/images/icon.png') }}" type="">

  <title> Victor Agro </title>
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="">
              <span style="color: green">
                Victor <span style="color: red"> Agro</span>
              </span>
            </a>
          ...
          <div class="owl-carousel">
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{ asset('frontend/images/client-1.png') }}" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
            ...
            <div class="item">
              <div class="box">
                ...
                <div class="client_id">
                  <div class="img-box">
                    <img src="{{ asset('frontend/images/client-2.png') }}" alt="" class="img-1">
                  </div>
                  <div class="name">
                    <h6>
                      Adipiscing
